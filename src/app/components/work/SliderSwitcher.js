  ...
  return (
    <div className="relative">
      <img
        ...
        className="shadow-lg w-full h-[250px] md:h-[400px] lg:h-[450px] rounded-xl object-contain md:object-cover lg:object-cover transition-all duration-300 cursor-default md:cursor-pointer"
      />
      <button
        onClick={goToPrevious}
        className="absolute top-1/2 left-1 md:left-1 lg:left-3 transform -translate-y-1/2 bg-[#AAAC24] text-white p-2 rounded-xl hover:bg-[#1A428A] transition-all duration-200"
      >
        <FaChevronLeft className="h-4 w-3 lg:h-6 lg:w-6 md:h-5 md:w-5 md:pr-1 lg:pr-1 lg:p-1" />
      </button>
      <button
        onClick={goToNext}
        className="absolute top-1/2 right-1 md:right-1 lg:right-3 transform -translate-y-1/2 bg-[#AAAC24] text-white p-2 rounded-xl hover:bg-[#1A428A] transition-all duration-200"
      >
