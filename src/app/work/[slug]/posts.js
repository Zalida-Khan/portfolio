const posts = [
    {
        ...
        gallery: [
            ...
            "/images/magazine/ao-magazine-mockup.jpg",
            "/images/magazine/Front-back.jpg",
            "/images/magazine/Magazine-Pages-1-2.jpg",
            "/images/magazine/Magazine-Pages-3-4.jpg",
            "/images/magazine/Magazine-Pages-5-6.jpg",
            "/images/magazine/Magazine-Pages-7-8.jpg",
            "/images/magazine/Magazine-Pages-9-10.jpg",
            "/images/magazine/Magazine-Pages-3-4.jpg"
        ]
    },
    {
        ...
        image: '/images/magic/Backview-cans-mockup.jpg',
        ...
        mandate: 'Create bold, playful cans for Sugar Magic’s Cherry, Lemon, and Blueberry flavours with vibrant pastel tones and whimsical fonts. Highlight a fun, youthful, and refreshing vibe.',
        ...
        packagingDesign: 'Flavor-specific designs with colour distinctions ensure brand consistency. Bilingual (English/French) labels are used for accessibility and designed with dieline templates.',
        ...
        gallery: [
            '/images/magic/COLOUR.png',
            '/images/magic/TYPOGRAPHY.png',
            '/images/magic/LOGO2.png',
            '/images/magic/Symbols.png',
            '/images/magic/ILLUSTRATIONS.png',
            '/images/magic/ILLUSTRATIONS2.png',
            '/images/magic/lemon-dieline.png',
            '/images/magic/blueberry-dieline.png',
            '/images/magic/cherry-dieline.png',
            '/images/magic/Cans-Mockup-Front.jpg',
            '/images/magic/Cans-Mockup-Back.jpg',
            '/images/magic/Le-flavour-mockup.jpg',
            '/images/magic/Blueberry-flavour-mockup.jpg',
            '/images/magic/Cherry-flavour-mockup.jpg',
        ]
    },
    {
        id: 3,
        slug: 'the-waterfall',
        title: 'The Waterfall',
        image: '/images/waterfall/Poster-bi.jpg',
        category: ['Graphic Design', 'Album Cover Design', 'Vinyl Covers'],
        ...
        gallery: [
            '/images/waterfall/Album_Poster_Design.jpg',
            '/images/waterfall/bi-poster-2.jpg',
    ...
    },
    {
        ...
        gallery: [
            '/images/exhibition/The-exhibition-poster.jpg',
            '/images/exhibition/The-Exhibition-Banner.jpg',
            '/images/exhibition/Billboard_Mockup_1.jpg',
            '/images/exhibition/Poster-Design-onBusStop.jpg',
        ]
    },
    {
        id: 5,
        ...
        category: ['Case Study', 'UI/UX Design', 'Graphic Design', 'Front-end Development'],
        ...
        mandate: 'Caregivers, including family and healthcare professionals, spend significant time on repetitive form-filling. The Aether App automates this process, making it easier to manage data and save time.',
        goal: 'To create a mobile app that automates the form-filling process, reduces errors, and saves caregivers valuable time, all while providing an easy-to-use interface that allows for quick form submissions without the need for repetitive manual data entry.',
        process: [
            {
                step: 'Research and User Insights',
                description: 'Conducted interviews and surveys with caregivers to identify their main challenges with repetitive form-filling tasks. Recognized the need for a solution that prioritizes accuracy and efficiency, tailored to their busy lifestyles.',
                image: '/images/aether/research-phase.jpg'
            },
            {
                step: 'Wireframing and User Flows',
                description: 'Created low-fidelity wireframes to visualize the app’s form input process and user flows. Developed high-fidelity prototypes based on user feedback to ensure the interface was intuitive and easy to navigate.',
                image: '/images/aether/lo-fi-wireframe.jpg'
            },
            {
                step: 'UI Design and Visual Branding',
                description: 'Designed a minimalist interface with a soothing color palette to enhance usability. Focused on simplifying the user experience with clear input fields and an intuitive layout, catering to caregivers with little to no technical experience.',
                image: '/images/aether/branding-design.jpg'
            },
            {
                step: 'Development',
                description: 'Developed the app using Next.js, incorporating automated form population to reduce manual work and improve accuracy. Ensured mobile responsiveness, allowing caregivers to access the app seamlessly on any device.',
                image: '/images/aether/development-phase.jpg'
            }
        ],
        challenges: [
            'Ensuring that automated form-filling was compatible with various form types while maintaining accuracy.',
            'Creating an intuitive and user-friendly experience for individuals who may not be familiar with digital tools.',
            'Designing an interface that is both visually accessible and minimizes cognitive load for users managing caregiving tasks.'
        ],
        outcomes: 'The Aether App reduced form-filling time by up to 50% in initial testing, with caregivers reporting significantly lower stress levels related to administrative tasks. The app’s straightforward design contributed to widespread adoption, even among caregivers with limited technical experience.',
        designDeliverables: [
            {
        ...
        gallery: [
            '/images/aether/primary-persona.png',
            '/images/aether/secondary-persona.png'
        ],
    ...
    },
    {
        ...
        gallery: [
            ...
            '/images/yolk/packaging-mockup.jpg',
            '/images/yolk/menu.jpg',
            '/images/yolk/menu2.jpg',
            '/images/yolk/menu3.jpg',
        ]
    }
