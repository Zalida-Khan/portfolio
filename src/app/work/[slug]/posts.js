const posts = [
    ...
    },    
    {
        ...
        "outcomes": "The Aether App reduced form-filling time by up to 50% in early testing, with caregivers reporting less stress and more efficiency in handling administrative tasks. The app was widely adopted due to its simple design and clear usability.",
        "designDeliverables": [
          {
      ...
      },         
    {
        ...
        title: 'The Yolk',
        heading: "Introduction",
        subheading: 'Infusing Vibrancy and Freshness into Every Bite with a Playful, Modern Menu Design',
        ...
        overview: ` The Yolk’s branding combines warm, sunny colors with clean typography to communicate freshness and creativity. The menu design is simple and user-friendly, ensuring an enjoyable dining experience. This cohesive branding is consistent across all materials, from the menu to packaging, reinforcing the restaurant's identity and enhancing its diverse offerings, including a special kids’ menu.`,
        gallery: [
