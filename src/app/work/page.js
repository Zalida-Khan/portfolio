...
export default function Work() {
    ...
    const posts = [
        ...
        { id: 2, slug: 'sugar-magic', title: 'Sugar Magic', image: '/images/magic/feature-sugarmagic.webp', category: ['Packaging Design', 'Graphic Design'] },
                        ...
                        {visiblePosts.length ? visiblePosts.map((post, index) => (
                            <Link href={`/work/${post.slug}`} key={post.id}>
                                ...
                                >
                                    ...
                                    <motion.div
                                        className="postContent absolute inset-0 bg-[#AAAC24] bg-opacity-100 pt-6 flex flex-col items-center justify-center opacity-0 hover:opacity-100 hidden sm:flex transition-opacity"
                                        initial={{ opacity: 0 }}
